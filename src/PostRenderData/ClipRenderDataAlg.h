#ifndef _CLIP_RENDERDATAALG_H_
#define _CLIP_RENDERDATAALG_H_
...
namespace Post {
	class POSTRENDERDATAAPI ClipRenderDataAlg : public RenderDataAlgorithm
	{
		AddProperty(bool, InsideOut, true)
	public:
		ClipRenderDataAlg(RenderDataObject* parent);
		~ClipRenderDataAlg();
		/**
		 * @brief 设置平面原点位置
		 * @param  ori
